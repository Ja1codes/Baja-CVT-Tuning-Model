function [Tp1,Tp0,Cpx,Fpx,Fps,Fflyx,Ffly,wpc,MPMax] = Primary(n,Tp,MBelt,Ts1,Wp,X1,Rp,Alpha,BeltSH,Uep,Ufly,Theta,Kp,Xp0,Delta,Mfly,Rfly,Mlink,Rlink)
...
%Pressure Spring
Fps=Kp*(Xp0+X1); %Pressure spring force vector (lbf)
